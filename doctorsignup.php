...
if (isset($_POST["d_signup"])) {
    ...
    if(strtolower($img_type) == "image/png" || strtolower($img_type) == "image/jpg" || strtolower($img_type) == "image/jpeg" ){
      ...
      if(move_uploaded_file($_FILES["d_img"]["tmp_name"] , $target)){
        $select = "SELECT * FROM `doctors_table` WHERE `doctor_name` = '$name' OR `doctor_gmail` = '$email'";
        ...
        if ($run) {
            ...
            {
                if (empty($name) || empty($email) || empty($pass) || empty($phone) || empty($location) || empty($skill)) {
                    echo "<script>
                alert('Please Fil All the input');
                </script>";
                } else {
                    $v_code = bin2hex(random_bytes(16));
                    $insert = "INSERT INTO `doctors_table`(`doctor_name`,`doctor_position`,`doctor_gmail`,`doctor_phone`,`doctor_location`,`doctor_pass`,`doctor_img`,`verifi_code`, `is_verifi`) VALUES ('$name','$skill','$email','$phone','$location','$pass','$img_name','$v_code','0') ";
        ...
        <div class="form">
            <form method="post" enctype="multipart/form-data">
                ...
                <div class="name_email">
                    ...
                    <div class="name">
                        <input type="text" name="d_name" class="name_input" placeholder="Enter Name" required>
                    </div>
                    <div class="name">
                ...
                <div class="phone_pass">
                    ...
                    <div class="pass">
                        <input type="password" name="d_pass" placeholder="Enter Password" required>
                    </div>
                    <div class="pass">
                        <input type="text" name="d_num" placeholder="Enter Phone Number" required>
                    </div>
                    <div class="phone_btn">
                ...
                <div class="location_skill">
                    ...
                    <div class="skill">
                        <input type="text" name="d_location" placeholder="Enter Your Location" required>
                    </div>
                    <div class="skill">
                        <input type="text" name="d_skill" placeholder="Your Skill" required>
                    </div>
                    <div class="skill">
                    <div class="input-group w-100 h-100">
                        <input type="file" name="d_img" class="form-control" id="inputGroupFile01">
                    </div>
                    </div>
                    <div class="signup">
                        <button class="back_3">Back</button>
                        <button type="submit" name="d_signup">Sign Up</button>
                    </div>
                </div>
