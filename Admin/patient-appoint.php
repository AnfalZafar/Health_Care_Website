        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Patient Appointment</h1>
                    <!-- <div class="btn_head w-100 d-flex justify-content-end">
                        <button class="btn btn-primary">Add</button>
                    </div>
                    -->
                    <!-- DataTales Example -->
                    <div class="tables_detail table-responsive mt-5">
                        <table class="table table-bordered ">
                            ...
                            <tbody>
                                <?php
                                $select = "SELECT * FROM `patient_appointment_table`";
                                ...
                                while ($data = mysqli_fetch_array($fire)) { ?>
                                    <tr>
                                        ...
                                        <td><textarea name="" id="" class="h-100 w-100 outline-0 border-0" style="background: transparent;outline: none;"><?php echo $data[4] ?></textarea></td>
                                        <td>
                                            <a href="patient_appoint_delete.php?delete=<?php echo $data[0] ?>" class="btn btn-danger"><i class="fa-solid fa-trash"></i></a>
