            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    while($data = mysqli_fetch_array($fire)){?>
                        <div class="col-auto w-50 m-auto">
                            <div class="box"
                                ...
                                <div class="detail-box">
                                    ...
                                    <div class="btnss">
                                        <a href="about_edit.php?editId=<?php echo $data['about_id']?>";
                                            class="btn btn-primary mr-3 ">Edit</a>
                                        <a href="about_delete.php?deleteid=<?php echo $data['about_id']?>"
                                            class="btn btn-danger mr-3">Delete</a>
