        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="main">
                        <div class="img">
                            <img src="img/<?php echo $fetch['doctor_img'] ?>" alt="">
                        ...
                        <div class="prifile">
                            <div class="information">
                                ...
                                <div class="info">
                                    <div class="name">
                                        <h3>Name:</h3>
                                        <h5><?php echo $fetch['doctor_name'] ?></h5>
                                    </div>
                                    <div class="name">
                                        <h3>Email:</h3>
                                        <h5><?php echo $fetch['doctor_gmail'] ?></h5>
                                    </div>
                                    <div class="name">
                                        <h3>Location:</h3>
                                        <h5><?php echo $fetch['doctor_location'] ?></h5>
                                    </div>
                                </div>
                            </div>
                            <div class="Skills">
                                ...
                                <div class="skill">
                                    <h3>Skill:</h3>
                                    <h5><?php echo $fetch['doctor_position'] ?></h5>
                                </div>
                                <div class="skill">
                                    <h3>Phone Number:</h3>
                                    <h5><?php echo $fetch['doctor_phone'] ?></h5>
                                </div>
                            </div>
                        </div>
                    </div>
