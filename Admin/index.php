                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Total Patient</div>
                                            <?php
                                            $select_2 = "SELECT * FROM `sign_table`";
                                            $run = mysqli_query($connect, $select_2);
                                            if ($run) {
                        ...
                        <div class="col-xl-4 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Total Appointment
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <?php
                                                    $select_3 = "SELECT * FROM `patient_appointment_table`";
                                                    $run_2 = mysqli_query($connect, $select_3);
                                                    if ($run_2) {
                                                        $num_rows = mysqli_num_rows($run_2);
                                                    }
                                                    ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-8 col-lg-7">
                            ...
                            <table class="table table-dark table-border">
                                ...
                                <tbody>
                                    <?php
                                    $select_table = "SELECT * FROM `sign_table`";
                                    $fire = mysqli_query($connect, $select_table);
                        ...
                        <div class="col-xl-4 col-lg-5">
                            ...
                            <table class="table table-dark">
                                ...
                                <tbody>
                                <?php
                                    $select_tables = "SELECT * FROM `patient_appointment_table`";
                                    $fires = mysqli_query($connect, $select_tables);
                                    while ($datas = mysqli_fetch_array($fires)) { ?>
                                        <tr>
                                            <td><?php echo $datas["patient_name"] ?></td>
                                            <td><?php echo $datas["patient_email"] ?></td>
                                        </tr>
                                    <?php
                                    }
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">Are You Shore to want to Logout</div>
