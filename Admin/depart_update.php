...
$get = $_GET["updatedepart"];
$select = "SELECT * FROM `depart_table` WHERE `depart_table`.`depart_id` = $get";
...
if (isset($_POST["depart-btn"])) {
    ...
    if (strtolower($img_type) == "image/png" || strtolower($img_type) == "image/jpg" || strtolower($img_type) == "image/jpeg") {
        ...
        if (move_uploaded_file($_FILES["department_fil"]["tmp_name"], $target)) {
            $update = "UPDATE `depart_table` SET `depart_name`='$name',`depart_descript`='$descript',`depart_icon`='$img_name' WHERE `depart_table`.`depart_id` = $get";
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-4 text-gray-800">Update Departments Page</h1>
                    ...
                    <form method="post" enctype="multipart/form-data" class="m-auto">
                        ...
                        <div class="form-group w-75 m-auto pt-4">
                            ...
                            <input type="text" name="department_name" value="<?php echo $fetch['depart_name'] ?>" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Departments Name">
                        </div>
                        <div class="form-group w-75 m-auto pt-4">
                            <label for="exampleInputPassword1">Description</label>
                            <textarea type="text" name="department_descript" value="<?php echo $fetch['depart_descript'] ?>" id="" class="w-100 h-25"></textarea>
                        </div>
                        <div class="form-group w-75 m-auto pt-4">
                            <label for="exampleFormControlFile1">Choose Icon</label>
                            <input type="file" name="department_fil" value="<?php echo $fetch['depart_icon'] ?>" class="form-control-file" id="exampleFormControlFile1">
                        </div>
