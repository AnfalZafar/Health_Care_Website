...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="btn_head w-100 d-flex justify-content-end">
                        <button class="btn btn-primary patient-detail-btn">Add</button>
                    </div>

                    <!-- DataTales Example -->
                    <div class="tables_detail mt-5">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <?php
                                $select = "SELECT * FROM `sign_table`";
                                $fire = mysqli_query($connect, $select);
                                while ($data = mysqli_fetch_array($fire)) {
                                ?>
                                    <tr>
                                        <td><?php echo $data["sign_name"] ?></td>
                                        <td><?php echo $data["sign_email"] ?></td>
                                        <td><?php echo $data["sign_phone"] ?></td>
                                        <td><?php echo $data["sign_date"] ?></td>
                                        <td>
                                            <a href="patient_edit.php?Id=<?php echo $data["sign_id"] ?>" class="edit-patient btn btn-warning"><i class="fa-solid fa-pen-to-square"></i></a>
                                            <a href="patient_delete.php?deleteId=<?php echo $data["sign_id"] ?>" class="btn btn-danger"><i class="fa-solid fa-trash"></i></a>
    ...
    <form class="depart_form w-50" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group w-75 m-auto pt-4">
            ...
            <input type="text" class="form-control-file" placeholder="Enter Name" id="exampleFormControlFile1">

        </div>

        <div class="form-group w-75 m-auto pt-4">
            <label for="exampleInputPassword1">Gmail</label>
            <input type="email" class="form-control-file" placeholder="Enter Gmail" id="exampleFormControlFile1">

        </div>
        <div class="form-group w-75 m-auto pt-4">
            <label for="exampleInputPassword1">Phone</label>
            <input type="number" class="form-control-file" placeholder="Enter Phone Number" id="exampleFormControlFile1">
    ...
    <script>
        let depart = document.querySelector(".depart_form"),
            ...
            btnss = document.querySelector(".patient-detail-btn");
